...
public class ApplyGoOut extends AppCompatActivity {
    ...
    private long sim_startTime, sim_endTime, l_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_go_work);
        ButterKnife.bind(this);
        layoutTitleTv.setText("外出申请");
        intent = new Intent();
        ...
        //实时保存
        sp_save = new SharedPreferencesHelper(this, "sp_save_GoOut");
    ...
    protected void onResume() {
        ...
        //从联系人跳过来的sp里的审批人id和
        listApprover_head_uid = new SharedPreferencesHelper(ApplyGoOut.this, "listApprover");
...
//                    }
        ...
        //适配器
        ShowAdpoverAdapter showAdpoverAdapter = new ShowAdpoverAdapter(ApplyGoOut.this, Arr_approver);
...
//        ShowPictureAdapter showPictureAdapter = new ShowPictureAdapter(WorkSummary.this, Arr_approver);
        ...
        //适配器
        ShowAdpoverAdapter showPictureAdapter2 = new ShowAdpoverAdapter(ApplyGoOut.this, Arr_approver2);
...
//        ShowPictureAdapter showPictureAdapter2 = new ShowPictureAdapter(WorkSummary.this, Arr_approver2);
    ...
    @OnClick({R.id.layout_back, R.id.click_leave_rl_endTime, R.id.click_leave_rl_startTime, R.id.click_rl_addApppover, R.id.click_rl_addApppover2, R.id.btnSubmit_leave})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.click_leave_rl_startTime://开始时间
                TimePickerView pvTime = new TimePickerBuilder(ApplyGoOut.this, new OnTimeSelectListener() {
                    @Override
                ...
                pvTime.show();
                break;
            case R.id.click_leave_rl_endTime:
                //时间选择器
                TimePickerView pvTime2 = new TimePickerBuilder(ApplyGoOut.this, new OnTimeSelectListener() {
            ...
            case R.id.click_rl_addApppover:
                approverTag = "0";
                intent = new Intent(ApplyGoOut.this, ChooseAdressActivity.class);
    ...
    private void updateRequest() {
        ...
        if (etApplyWhy.getText().toString().isEmpty()) {
            Toast.makeText(this, "请输入外出原因", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        OkHttpUtils.post().url(Contents.GOOUT)
                ...
                .addParams("out_notes", etApplyWhy.getText().toString())
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.get("errno").equals("200")) {
                        clickNum = clickNum + 1;
                        Toast.makeText(ApplyGoOut.this, "提交成功", Toast.LENGTH_SHORT).show();
                        sp_save.clear();
                        finish();
                    }
