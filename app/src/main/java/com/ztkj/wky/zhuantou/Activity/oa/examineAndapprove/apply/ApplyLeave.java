...
public class ApplyLeave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //实时保存
        sp_save = new SharedPreferencesHelper(this, "sp_save_Leave");
        ...
        Log.e(TAG, "onCreate: llllllllllllllll" + l_time);
        if (l_time != 0) {
    ...
    protected void onResume() {
        ...
        //从联系人跳过来的sp里的审批人id和
        listApprover_head_uid = new SharedPreferencesHelper(ApplyLeave.this, "listApprover");
...
//                    }
        ...
        //适配器
        ShowAdpoverAdapter showAdpoverAdapter = new ShowAdpoverAdapter(ApplyLeave.this, Arr_approver);
...
//        ShowPictureAdapter showPictureAdapter = new ShowPictureAdapter(WorkSummary.this, Arr_approver);
        ...
        //适配器
        ShowAdpoverAdapter showPictureAdapter2 = new ShowAdpoverAdapter(ApplyLeave.this, Arr_approver2);
...
//        ShowPictureAdapter showPictureAdapter2 = new ShowPictureAdapter(WorkSummary.this, Arr_approver2);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.click_leave_rl_startTime://开始时间
                ...
                TimePickerView pvTime = new TimePickerBuilder(ApplyLeave.this, new OnTimeSelectListener() {
                    @Override
            ...
            case R.id.click_leave_rl_endTime: //结束时间
                ...
                //时间选择器
                TimePickerView pvTime2 = new TimePickerBuilder(ApplyLeave.this, new OnTimeSelectListener() {
            ...
            case R.id.click_rl_addApppover:
                approverTag = "0";
                intent = new Intent(ApplyLeave.this, ChooseAdressActivity.class);
    ...
    private void updateRequest() {
        ...
        if (etReasonForLeave.getText().toString().isEmpty()) {
            Toast.makeText(this, "请输入请假原因", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        OkHttpUtils.post().url(Contents.ADDLEAVE)
                ...
                .addParams("lea_notes", etReasonForLeave.getText().toString())
...
//                Log.e(TAG, "onResponse: " + response);
                try {
                    ...
                    if (jsonObject.get("errno").equals("200")) {
                        clickNum = clickNum + 1;
                        sp_save.clear();
                        Toast.makeText(ApplyLeave.this, "提交成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
