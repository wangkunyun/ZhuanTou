...
public class AlreadySendDetailsActivity extends AppCompatActivity {
    ...
    @BindView(R.id.tv_AutoReceiver)
    TextView tvAutoReceiver;
    @BindView(R.id.lin_clickLogisticsDetails)
    LinearLayout linClickLogisticsDetails;
    ...
    @BindView(R.id.tv_clickAffirmReceive)
    TextView tvClickAffirmReceive;
            ...
            public void onResponse(String response) {
                ...
                if (orderDetailsBean.getErrno().equals("200")) {
                    ...
                    if (!data.getSs_logo().equals("0")) {
                        ...
                        Glide.with(AlreadySendDetailsActivity.this).load(data.getSs_logo())
                                .apply(options).into(imgStoreHead);
                    }
    ...
    public static void start(Context context, String orderState, String orderNum, OrderBean.DataBean dataBean) {
        Intent starter = new Intent(context, AlreadySendDetailsActivity.class);
    ...
    @OnClick({R.id.layout_back, R.id.lin_clickLogisticsDetails, R.id.tv_clickCopy, R.id.tv_clickAffirmReceive})
    ...
    class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(AlreadySendDetailsActivity.this).inflate(R.layout.item_layout_order_details, viewGroup, false);
        ...
        public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
            Glide.with(AlreadySendDetailsActivity.this).load(arr.get(i).getSc_img()).into(viewHolder.item_imgOrderDetailsPic);
            ...
            viewHolder.item_tvClickRefund.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    RefundActivity.start(AlreadySendDetailsActivity.this, dataBean);
                }
            });
        }
