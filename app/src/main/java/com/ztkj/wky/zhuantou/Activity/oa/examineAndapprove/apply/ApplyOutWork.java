...
public class ApplyOutWork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_out_work);
        ButterKnife.bind(this);

        layoutTitleTv.setText("外勤申请");
        intent = new Intent();
...
//实时保存
        sp_save = new SharedPreferencesHelper(this, "sp_save_OutWork");
    ...
    protected void onResume() {
        ...
        //从联系人跳过来的sp里的审批人id和
        listApprover_head_uid = new SharedPreferencesHelper(ApplyOutWork.this, "listApprover");
...
//                    }
        ...
        //适配器
        ShowAdpoverAdapter showAdpoverAdapter = new ShowAdpoverAdapter(ApplyOutWork.this, Arr_approver);
...
//        ShowPictureAdapter showPictureAdapter = new ShowPictureAdapter(WorkSummary.this, Arr_approver);
        ...
        //适配器
        ShowAdpoverAdapter showPictureAdapter2 = new ShowAdpoverAdapter(ApplyOutWork.this, Arr_approver2);
...
//        ShowPictureAdapter showPictureAdapter2 = new ShowPictureAdapter(WorkSummary.this, Arr_approver2);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.click_leave_rl_startTime://开始时间
                ...
                TimePickerView pvTime = new TimePickerBuilder(ApplyOutWork.this, new OnTimeSelectListener() {
                    @Override
            ...
            case R.id.click_leave_rl_endTime: //结束时间
                ...
                //时间选择器
                TimePickerView pvTime2 = new TimePickerBuilder(ApplyOutWork.this, new OnTimeSelectListener() {
            ...
            case R.id.click_rl_addApppover:
                approverTag = "0";
                intent = new Intent(ApplyOutWork.this, ChooseAdressActivity.class);
    ...
    private void updateRequest() {
        ...
        if (etApplyWhy.getText().toString().isEmpty()) {
            Toast.makeText(this, "请输入外勤原因", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        OkHttpUtils.post().url(Contents.PERSONNEL)
                ...
                .addParams("fie_note", etApplyWhy.getText().toString())
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.get("errno").equals("200")) {
                        clickNum = clickNum + 1;
                        sp_save.clear();
                        Toast.makeText(ApplyOutWork.this, "提交成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
