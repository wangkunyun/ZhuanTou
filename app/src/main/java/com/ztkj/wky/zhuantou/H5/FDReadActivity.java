...
public class FDReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fdread);
        ButterKnife.bind(this);


        intent = getIntent();
        String h5Url = intent.getStringExtra("h5Url");
        String h5Title = intent.getStringExtra("h5Title");
        layoutTitleTv.setText(h5Title);
        mAgentWeb = AgentWeb.with(this)
                ...
                .go(h5Url); //WebView载入该url地址的页面并显示。
