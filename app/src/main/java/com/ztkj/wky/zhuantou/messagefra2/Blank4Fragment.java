...
public class Blank4Fragment extends Fragment {
    ...
    //    @BindView(R.id.blank4_rv)
//    RecyclerView blank4Rv;
    Unbinder unbinder;
    public static RecyclerView blank4Rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        blank4Rv = view.findViewById(R.id.blank4_rv);
        blank4Rv.setHasFixedSize(true);
        blank4Rv.setNestedScrollingEnabled(false);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (fenLeiBean.getErrno().equals("200")) {
                            cl_id = fenLeiBean.getData().get(0).getSubordinate().get(3).getCl_id();
                                    ...
                                    .execute(new StringCallback() {
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            if (rvBean1.getErrno().equals("200")) {
                                                ...
                                                blank4Rv.setLayoutManager(new LinearLayoutManager(getContext()));
                                                blank4Rv.setAdapter(myAdapter);
