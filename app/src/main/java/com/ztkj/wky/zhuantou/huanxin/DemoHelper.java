package com.ztkj.wky.zhuantou.huanxin;
...
import com.ztkj.wky.zhuantou.huanxin.db.DemoDBManager;
import com.ztkj.wky.zhuantou.huanxin.db.InviteMessgeDao;
import com.ztkj.wky.zhuantou.huanxin.db.UserDao;
import com.ztkj.wky.zhuantou.huanxin.domain.EmojiconExampleGroupData;
import com.ztkj.wky.zhuantou.huanxin.domain.InviteMessage;
import com.ztkj.wky.zhuantou.huanxin.domain.RobotUser;
import com.ztkj.wky.zhuantou.huanxin.parse.UserProfileManager;
import com.ztkj.wky.zhuantou.huanxin.receiver.CallReceiver;
import com.ztkj.wky.zhuantou.huanxin.receiver.HeadsetReceiver;
import com.ztkj.wky.zhuantou.huanxin.utils.PreferenceManager;
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                Intent intent = new Intent(appContext, ECChatAcitivty.class);
...
//                break;
    ...
    private EaseUser getUserInfo(String username) {
        ...
        EaseUser user = null;
        SharedPreferencesHelper sharedPreferencesHelper = new SharedPreferencesHelper(MyApplication.applicationContext, "anhua");
        ...
        if (contactList != null && contactList.containsKey(username)) {
            HttpRequest.POST(MyApplication.applicationContext, "https://api.zhuantoukj.com/birck/index.php/Home/IM/userInfo"
                    , new Parameter()
                            .add("token", token)
                            .add("phone", username)
                    , new ResponseListener() {
                        ...
                        public void onResponse(String response, Exception error) {
                            if (error == null) {
                                ...
                                if (map.get("errno").equals("200")) {
                                    Map<String, String> data = JSONUtils.parseKeyAndValueToMap(map.get("data"));
//                                    message.setAttribute("head_pic", data.get("head"));//后台给
//                                    message.setAttribute("nickname", data.get("nickname"));//后台给
