...
public class Blank3Fragment extends Fragment {
    ...
    //    @BindView(R.id.blank3_rv)
//    RecyclerView blank3Rv;
    Unbinder unbinder;
    public static RecyclerView blank3Rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        blank3Rv = view.findViewById(R.id.blank3_rv);
        blank3Rv.setHasFixedSize(true);
        blank3Rv.setNestedScrollingEnabled(false);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (fenLeiBean.getErrno().equals("200")) {
                            cl_id = fenLeiBean.getData().get(0).getSubordinate().get(2).getCl_id();
                                    ...
                                    .execute(new StringCallback() {
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            if (rvBean1.getErrno().equals("200")) {
                                                ...
                                                blank3Rv.setLayoutManager(new LinearLayoutManager(getContext()));
                                                blank3Rv.setAdapter(myAdapter);
