 ...
 */
public class StatisticalMineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_statistical__table, container, false);
    ...
    @SuppressLint("SetTextI18n")
    @OnClick({R.id.img_click_lase, R.id.img_click_next, R.id.rl_click_pj, R.id.rl_click_cq, R.id.rl_click_xx, R.id.rl_click_cd, R.id.rl_click_zt, R.id.rl_click_qk, R.id.rl_click_kg, R.id.rl_click_wq, R.id.rl_click_jb})
    ...
    private void requestMineDetails(int num, RecyclerView re) {
        ...
        OkHttpUtils.post().url(Contents.MINESTATISTICSDETAILS)
            ...
            public void onResponse(String response) {
                ...
                MineStaticalDetailsAdapter mineStaticalDetailsAdapter = new MineStaticalDetailsAdapter(getActivity(), data, num);
