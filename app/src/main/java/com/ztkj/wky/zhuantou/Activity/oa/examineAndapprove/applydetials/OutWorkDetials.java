...
import com.ztkj.wky.zhuantou.bean.OutWorkDetialsBean;
...
public class OutWorkDetials extends AppCompatActivity {
    ...
    @BindView(R.id.detials_numday)
    TextView detialsNumday;
    @BindView(R.id.detials_reason)
    TextView detialsReason;
    ...
    private String TAG = "OutWorkDetials";
    private String head;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_work_detials);
        ButterKnife.bind(this);
        toolbarTitle.setText("出差申请");
        intent = getIntent();
    ...
    private void request(String id) {
        OkHttpUtils.post()
            ...
            public void onResponse(String response) {
                ...
                OutWorkDetialsBean outWorkDetialsBean = new Gson().fromJson(response, OutWorkDetialsBean.class);
                OutWorkDetialsBean.DataBean data = outWorkDetialsBean.getData();
                ...
                detialsReason.setText(data.getReason());
                detialsPlace.setText(data.getPlace());
                detialsNumday.setText(data.getNumday()+"天");
                //设置图片圆角角度
                RoundedCorners roundedCorners = new RoundedCorners(96);
                RequestOptions options = RequestOptions.bitmapTransform(roundedCorners);
                Glide.with(OutWorkDetials.this).load(head)
                        .apply(options).into(detailsReportImgHead);
                Glide.with(OutWorkDetials.this).load(data.getApprover().getHead())
                        .apply(options).into(detailsImgAppover);
                detailsTvAppover.setText(data.getApprover().getName());

                List<OutWorkDetialsBean.DataBean.CopierBean> copier = data.getCopier();
                ...
                AppoverAdapter appoverAdapter = new AppoverAdapter(OutWorkDetials.this, appovername, appoverhead);
                GridLayoutManager gridLayoutManager = new GridLayoutManager(OutWorkDetials.this, 5);
