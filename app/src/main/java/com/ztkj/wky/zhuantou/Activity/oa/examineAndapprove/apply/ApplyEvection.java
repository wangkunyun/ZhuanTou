...
public class ApplyEvection extends AppCompatActivity {
    ...
    TextView applyHour;
    @BindView(R.id.et_apply_why)
    EditText etApplyWhy;
    @BindView(R.id.et_apply_place)
    EditText etApplyPlace;
    ...
    private long sim_startTime, sim_endTime, l_time, l;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_evection);
        ButterKnife.bind(this);

        layoutTitleTv.setText("出差申请");
        intent = new Intent();
        ...
        //实时保存
        sp_save = new SharedPreferencesHelper(this, "sp_save_Evection");
        ...
        l = (long) sp_save.getSharedPreference("l", 0l);
        if (!tv_1.isEmpty()) {
            etApplyWhy.setText(tv_1);
        }
        if (!tv_2.isEmpty()) {
            etApplyPlace.setText(tv_2);
        }
        if (l != 0) {
            applyHour.setText(l + "天");
        }
    ...
    protected void onResume() {
        ...
        //从联系人跳过来的sp里的审批人id和
        listApprover_head_uid = new SharedPreferencesHelper(ApplyEvection.this, "listApprover");
...
//                    }
        ...
        //适配器
        ShowAdpoverAdapter showAdpoverAdapter = new ShowAdpoverAdapter(ApplyEvection.this, Arr_approver);
...
//        ShowPictureAdapter showPictureAdapter = new ShowPictureAdapter(WorkSummary.this, Arr_approver);
        ...
        //适配器
        ShowAdpoverAdapter showPictureAdapter2 = new ShowAdpoverAdapter(ApplyEvection.this, Arr_approver2);
...
//        ShowPictureAdapter showPictureAdapter2 = new ShowPictureAdapter(WorkSummary.this, Arr_approver2);
    ...
    @OnClick({R.id.layout_back, R.id.click_leave_rl_startTime, R.id.click_leave_rl_endTime, R.id.click_rl_addApppover, R.id.click_rl_addApppover2, R.id.btnSubmit_leave})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.click_leave_rl_startTime://开始时间
                TimePickerView pvTime = new TimePickerBuilder(ApplyEvection.this, new OnTimeSelectListener() {
                    @Override
            ...
            case R.id.click_leave_rl_endTime://结束时间
                ...
                //时间选择器
                TimePickerView pvTime2 = new TimePickerBuilder(ApplyEvection.this, new OnTimeSelectListener() {
            ...
            case R.id.click_rl_addApppover:
                approverTag = "0";
                intent = new Intent(ApplyEvection.this, ChooseAdressActivity.class);
    ...
    private void updateRequest() {
        ...
        if (etApplyWhy.getText().toString().isEmpty()) {
            Toast.makeText(this, "请输入出差原因", Toast.LENGTH_SHORT).show();
            return;
        }
        if (etApplyPlace.getText().toString().isEmpty()) {
        ...
        OkHttpUtils.post().url(Contents.BUSINESSTRAVEL)
                ...
                .addParams("numday", l + "")
                .addParams("reason", etApplyWhy.getText().toString())
                .addParams("place", etApplyPlace.getText().toString())
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.get("errno").equals("200")) {
                        clickNum = clickNum + 1;
                        sp_save.clear();
                        Toast.makeText(ApplyEvection.this, "提交成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
    ...
    protected void onDestroy() {
        ...
        if (clickNum == 0) {
            sp_save.put("tv1", etApplyWhy.getText().toString());
            sp_save.put("tv2", etApplyPlace.getText().toString());
