...
import com.ztkj.wky.zhuantou.bean.LeaveDetailsBean;
...
public class LeaveDetials extends AppCompatActivity {
    ...
    private void request(String id) {
        OkHttpUtils.post()
            ...
            public void onResponse(String response) {
                ...
                LeaveDetailsBean leaveDetailsBean = new Gson().fromJson(response, LeaveDetailsBean.class);
                LeaveDetailsBean.DataBean data = leaveDetailsBean.getData();
                ...
                detialsDetials.setText(data.getLea_notes());
                //设置图片圆角角度
                RoundedCorners roundedCorners = new RoundedCorners(96);
                RequestOptions options = RequestOptions.bitmapTransform(roundedCorners);
                Glide.with(LeaveDetials.this).load(head)
                ...
                AppoverAdapter appoverAdapter = new AppoverAdapter(LeaveDetials.this, appovername, appoverhead);
                GridLayoutManager gridLayoutManager = new GridLayoutManager(LeaveDetials.this, 5);
