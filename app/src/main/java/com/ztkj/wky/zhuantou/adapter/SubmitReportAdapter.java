...
public class SubmitReportAdapter extends RecyclerView.Adapter<SubmitReportAdapter.ViewHolder> {
    private Context context;
    private List<SubmitReportBean.DataBean> data;


    public SubmitReportAdapter(Context context, List<SubmitReportBean.DataBean> data) {
