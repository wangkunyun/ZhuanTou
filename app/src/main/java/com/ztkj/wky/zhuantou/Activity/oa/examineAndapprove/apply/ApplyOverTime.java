...
public class ApplyOverTime extends AppCompatActivity {
    ...
    TextView applyHour;
    @BindView(R.id.et_ReasonForLeave)
    ...
    private String TAG = "ApplyOverTime";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_over_time);
        ButterKnife.bind(this);
        layoutTitleTv.setText("加班申请");
...
//实时保存
        sp_save = new SharedPreferencesHelper(this, "sp_save_OverTime");
    ...
    protected void onResume() {
        ...
        //从联系人跳过来的sp里的审批人id和
        listApprover_head_uid = new SharedPreferencesHelper(ApplyOverTime.this, "listApprover");
...
//                    }
        ...
        //适配器
        ShowAdpoverAdapter showAdpoverAdapter = new ShowAdpoverAdapter(ApplyOverTime.this, Arr_approver);
...
//        ShowPictureAdapter showPictureAdapter = new ShowPictureAdapter(WorkSummary.this, Arr_approver);
        ...
        //适配器
        ShowAdpoverAdapter showPictureAdapter2 = new ShowAdpoverAdapter(ApplyOverTime.this, Arr_approver2);
...
//        ShowPictureAdapter showPictureAdapter2 = new ShowPictureAdapter(WorkSummary.this, Arr_approver2);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.layout_back:
                finish();
                break;
            case R.id.click_leave_rl_startTime:

                TimePickerView pvTime = new TimePickerBuilder(ApplyOverTime.this, new OnTimeSelectListener() {
                    @Override
            ...
            case R.id.click_leave_rl_endTime:
                //时间选择器
                TimePickerView pvTime2 = new TimePickerBuilder(ApplyOverTime.this, new OnTimeSelectListener() {
            ...
            case R.id.click_rl_addApppover:
                approverTag = "0";
                intent = new Intent(ApplyOverTime.this, ChooseAdressActivity.class);
    ...
    private void updateRequest() {
        ...
        if (etReasonForLeave.getText().toString().isEmpty()) {
            Toast.makeText(this, "请输入加班原因", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        OkHttpUtils.post().url(Contents.OVERTIME)
                ...
                .addParams("over_note", etReasonForLeave.getText().toString())
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.get("errno").equals("200")) {
                        clickNum = clickNum + 1;
                        sp_save.clear();
                        Toast.makeText(ApplyOverTime.this, "提交成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
    ...
    protected void onDestroy() {
        ...
        if (clickNum == 0) {
            sp_save.put("tv1", etReasonForLeave.getText().toString());
