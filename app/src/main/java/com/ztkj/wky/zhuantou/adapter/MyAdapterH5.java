...
public class MyAdapterH5 extends RecyclerView.Adapter<MyAdapterH5.ViewHolder> {
    ...
    public MyAdapterH5(List<RvBean1.DataBean.ListBean> mData, Context context) {
        this.mData = mData;
        this.context = context;
    }

    public MyAdapterH5(List<FangKeJiKvBean.DataBean> mData, StringCallback stringCallback) {
