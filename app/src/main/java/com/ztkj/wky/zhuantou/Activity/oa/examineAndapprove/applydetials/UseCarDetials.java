...
import com.ztkj.wky.zhuantou.adapter.UserCarDetialsBean;
...
public class UseCarDetials extends AppCompatActivity {
    ...
    private String TAG = "UseCarDetials";
    private String head;
    private List<UserCarDetialsBean.DataBean.CopierBean> copier;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_use_car_detials);
    ...
    private void request(String id) {
        OkHttpUtils.post()
            ...
            public void onResponse(String response) {
                UserCarDetialsBean userCarDetialsBean = new Gson().fromJson(response, UserCarDetialsBean.class);
                UserCarDetialsBean.DataBean data = userCarDetialsBean.getData();
                detailsReportName.setText(data.getU_name() + "的用车申请");
                ...
                detialsObjective.setText(data.getObjective());
                //设置图片圆角角度
                RoundedCorners roundedCorners = new RoundedCorners(96);
                RequestOptions options = RequestOptions.bitmapTransform(roundedCorners);
                Glide.with(UseCarDetials.this).load(head)
                        .apply(options).into(detailsReportImgHead);
                Glide.with(UseCarDetials.this).load(data.getApprover().getHead())
                ...
                AppoverAdapter appoverAdapter = new AppoverAdapter(UseCarDetials.this, appovername, appoverhead);
                GridLayoutManager gridLayoutManager = new GridLayoutManager(UseCarDetials.this, 5);
